...
//         <Button type="submit" color="dark" size="sm">Sign Up</Button>
//       </Form>
//     </div>
//   );
// }
  ...
  return (
    <div className="register-background">
      <div className="register-form-container">
        ...
        <Form onSubmit={formik.handleSubmit}>
          <FormGroup>
            <Label htmlFor="name" className="form-check-label">Enter the Name of the Centre/Hospital</Label>
            <Input
              type="text"
              value={formik.values.name}
              name="name"
          ...
          <FormGroup>
            <Label htmlFor="email" className="form-check-label">Enter Email</Label>
            <Input
              type="email"
              value={formik.values.email}
              name="email"
          ...
          <FormGroup>
            <Label htmlFor="password" className="form-check-label">Enter Password</Label>
            <Input
              type="password"
              value={formik.values.password}
              name="password"
          ...
          <FormGroup>
            <Label htmlFor="confirmPassword" className="form-check-label">Confirm Password</Label>
            <Input
              type="password"
              value={formik.values.confirmPassword}
              name="confirmPassword"
          ...
          <FormGroup>
            <Label className="form-check-label">Select a Role</Label><br />
            <div className="form-check form-check-inline">
              <Input
                type="radio"
                value="Centre"
